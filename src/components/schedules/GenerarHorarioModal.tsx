...
// Llama a la RPC generate_schedule con los parámetros definidos por el supervisor.
...
export default function GenerarHorarioModal({ scheduleId, open, onClose, onGenerated }: Props) {
  ...
  const [diaLibreBase,    setDiaLibreBase   ] = useState("6");     // Domingo
  const [durAlmuerzo,     setDurAlmuerzo    ] = useState("60");    // 60 min
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              El resto de agentes rotarán a partir de este día.
            </p>
          ...
          <div className="flex items-center justify-between rounded-lg border px-3 py-2">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Si está activo, no sobreescribirá turnos ya asignados.
              </p>
            </div>
            <Switch
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isPending || !horaInicio || !horaFin}
            className="gap-2"
          >
            {isPending ? (
