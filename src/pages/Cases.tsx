...
export default function Cases() {
  ...
  const [form, setForm] = useState({ cliente_id: 0, tipo_servicio_id: 0, descripcion_inicial: "" });
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setCreateOpen(false);
      setForm({ cliente_id: 0, tipo_servicio_id: 0, descripcion_inicial: "" });
    } catch (err: any) {
          ...
          <DialogContent className="max-w-lg">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={form.tipo_servicio_id ? String(form.tipo_servicio_id) : ""} onValueChange={v => setForm(f => ({ ...f, tipo_servicio_id: Number(v) }))}>
